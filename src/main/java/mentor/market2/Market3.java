...
public class Market3 {
    ...
    private static void adminMenu(List<String> manavUrunler, List<String> kasapUrunler, List<String> icecekUrunler, List<String> sepetim, Scanner input) {
        ...
        switch (secenek){
            case"E":
                urunEkle( manavUrunler, kasapUrunler, icecekUrunler, sepetim, input);
                break;
            case"D":
    ...
    private static void urunEkle(List<String> manavUrunler, List<String> kasapUrunler, List<String> icecekUrunler, List<String> sepetim, Scanner input) {
        System.out.println("hangi liosteyi degistirmek istiyorsun");
        System.out.println(" manav 1 ,, kasap 2,,, Icecek 3,, Cikis icin 4");
...
String yeniUrun="";
        switch (bolum2){
            ...
            case 1:
                ...
                yeniUrun = input2.nextLine().trim();
                       manavUrunler.add(yeniUrun);
                     System.out.println("eklenen urun "+yeniUrun);
                urunEkle( manavUrunler, kasapUrunler, icecekUrunler, sepetim, input);
            break;
            case 2:
                Scanner input4 = new Scanner(System.in);
                System.out.println("ururn bilgisini giriniz");
                yeniUrun = input4.nextLine().trim();
            ...
            case 3:
                ...
                System.out.println("ururn bilgisini giriniz");
                yeniUrun = input3.nextLine().trim();
                System.out.println("ururn bilgisini giriniz");
                yeniUrun= input.nextLine().trim();
